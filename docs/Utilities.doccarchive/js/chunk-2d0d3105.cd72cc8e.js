          ...
          if (
            ...
            (s.prototype.THROTTLE_TIMEOUT = 100),
                ...
                if (n && -1 == this._monitoringDocuments.indexOf(e)) {
                  ...
                  this.POLL_INTERVAL
                    ...
                    this._monitoringUnsubscribes.push(function () {
                      var t = e.defaultView;
                      t && (r && t.clearInterval(r), a(t, "resize", o, !0)),
                        a(e, "scroll", o, !0),
                        s && s.disconnect();
                    });
                  var h =
                ...
                if (-1 != n) {
                  var o =
                    ...
                    r = this._observationTargets.some(function (t) {
                      ...
                      while (n && n != o) {
                        var r = i(n);
                        if (((n = r && r.ownerDocument), n == e)) return !0;
                      }
                      return !1;
                    });
                  if (!r) {
                    ...
                    if (h == this.root || 9 == h.nodeType)
                      if (((u = !0), h == this.root || h == t))
                        ...
                        var p = v(h),
                          ...
                          m =
                            p &&
                            this._computeTargetAndRootIntersection(p, d, r);
                        d && m
                          ? ((h = p), (c = g(d, m)))
                          : ((h = null), (s = null));
                      }
              ...
              (s.prototype._getRootRect = function () {
                var e;
                if (this.root && !w(this.root)) e = f(this.root);
                else {
                  var n = w(this.root) ? this.root : t,
                    o = n.documentElement,
                    i = n.body;
                  e = {
                    top: 0,
